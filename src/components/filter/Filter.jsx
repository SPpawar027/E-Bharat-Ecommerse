...
const Filter = () => {
    ...
    const { mode , product ,  searchkey , setSearchkey ,filterPrice ,setFilterPrice , filterType ,setFilterType} = context
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
                            ...
                            {product.map((item)=>{
                                return (
                                    ...
                                    <option value={item.price} onChange={(e)=>setFilterPrice(e.target.value)}>{item.price}</option>
                                )
